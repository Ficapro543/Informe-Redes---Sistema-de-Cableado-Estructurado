...
\centering\includegraphics[width=4cm]{Componentes/01_cable_cat6a.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/02_patchpanel_24p.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/03_jack_cat6a.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/04_patchcord_cat6a_2.1m.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/05_patchcord_cat6a_1.0m.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/06_kitfibraoptica_4hilos.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/07_faceplate_2puertos.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/08_cajasuperficial_1modulo.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/09_organizadorhorizontal_1u.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/10_bandejaportaequipos_1u.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/11_gabinetepiso_42U.jpg} \\
\end{tabular}
\end{table}
...
Gabinete de 19'' x 24U. Se reutiliza este mismo modelo en los dos distribuidores de piso: IDF-03 (3er piso) e IDF-04 (4to piso). &
\centering\includegraphics[width=4cm]{Componentes/12_gabinetepared_42U.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/13_barra_TMGB.jpg} \\
\end{tabular}
\end{table}
...
Barra secundaria instalada en cada IDF, interconectada a la TMGB. Se instalan 2 unidades (IDF-03 e IDF-04). &
\centering\includegraphics[width=4cm]{Componentes/14_barra_TGB.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/15_switchcatalyst_ciscoc9200_24p.jpg} \\
\end{tabular}
\end{table}
...
Switch de acceso 24 puertos PoE+, uplink 10G SFP+. Modelo de referencia no instalado en el alcance actualizado; el primer piso no tiene IDF y sus cables suben al MDF del segundo piso. &
\centering\includegraphics[width=4cm]{Componentes/16_switchcatalyst_ciscoc9200_48p.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/17_transceptor_10gsr.jpg} \\
\end{tabular}
\end{table}
...
Sistema de alimentación ininterrumpida de doble conversión, autonomía mínima 15 min a plena carga. Uno por gabinete principal (3 unidades). &
\centering\includegraphics[width=4cm]{Componentes/18_upsonline_3kva.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/19_accesspoint_wifi6.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/20_camaraip_2mp.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/21_nvr_16canales.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/22_escalerillaelectrozincada_300mm.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/23_canaletapvc_doblevia40x20mm_divisor.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/24_tuberiaconduit_emt1''.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/25_cajaregistro_metalica.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/26_selloconrtafuego_intumescente.jpg} \\
\end{tabular}
\end{table}
...
\centering\includegraphics[width=4cm]{Componentes/27_certificadorfluke_dsx-8000.jpg} \\
\end{tabular}
\end{table}
