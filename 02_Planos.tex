...
]{Planos/Informatica/INFORMATICA_3erPISO.pdf}
...
\includepdf[
    ...
    scale=0.8,
    pagecommand={
        \section*{Tercer piso -- Plano volteado (Informatica 3er piso)}
        \thispagestyle{plain}
    }
]{Planos/Informatica/INFORMATICA_3erPISO_Volteado.pdf}
...
]{Planos/Informatica/INFORMATICA_4toPISO.pdf}
...
\includepdf[
    ...
    scale=0.8,
    pagecommand={
        \section*{Cuarto piso -- Plano volteado (Informatica 4to piso)}
        \thispagestyle{plain}
    }
]{Planos/Informatica/INFORMATICA_4toPISO_Volteado.pdf}
...
]{Planos/Informatica/INFORMATICA_TECHO.pdf}
...
\includepdf[
    ...
    scale=0.8,
    pagecommand={
        \section*{Techo -- Plano volteado (Informatica techo)}
        \thispagestyle{plain}
    }
]{Planos/Informatica/INFORMATICA_TECHO_Volteado.pdf}
