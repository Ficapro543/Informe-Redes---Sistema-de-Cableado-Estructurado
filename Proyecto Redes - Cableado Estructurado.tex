...
% ---------------------------------------------------------------
\newcommand{\totalPuntos}{587}
\newcommand{\totalPuntosDatos}{557}
\newcommand{\totalAP}{16}
\newcommand{\totalCamaras}{14}
\newcommand{\totalPisos}{4}
\newcommand{\totalSwitchesCuarentaYOcho}{7}
...
\newcommand{\cajaCableCatSeisA}{107}      % Cajas de 305m F/UTP Cat 6A estimadas con el metrado de la cotización consolidada
