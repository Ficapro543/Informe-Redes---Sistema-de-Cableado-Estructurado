...
\begin{enumerate}
    \item \textbf{Muestra:} Se seleccionará al azar una muestra representativa (10\% de 681 puntos, es decir, 68 nodos) distribuidos entre los \totalPisos{} niveles, con énfasis en el Nivel 3 (mayor densidad de laboratorios).
...
\begin{itemize}
    \item \textbf{Dossier de Certificación:} Archivo digital nativo y PDF con los \totalPuntos{} reportes individuales ``PASA'' de cobre F/UTP Cat 6A, más los 3 reportes de fibra óptica OM4 del backbone.
