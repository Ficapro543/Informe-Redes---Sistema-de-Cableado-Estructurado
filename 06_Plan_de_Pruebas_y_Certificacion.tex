...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Tipo de Cable:} U/UTP Cat 6A LSZH.
...
Se ejecutará la secuencia de Autotest en el 100\% de los nodos (aprox. 310 puntos), evaluando los siguientes parámetros críticos para la operación a 500 MHz:
...
La aceptación final del proyecto estará condicionada a la entrega de un Dossier de Calidad que documente el desempeño de cada uno de los 310 puntos de red instalados. Los reportes deberán cumplir con las siguientes características formales:
...
Adicionalmente, se entregará un listado resumen que condense en una tabla los 310 IDs de los puntos, la longitud de cada uno y el estado final (``PASA''), sirviendo como inventario rápido de la infraestructura entregada.
...
La red será aceptada únicamente si el 100\% de los puntos instalados (310 nodos) cuentan con un certificado de prueba con resultado ``PASA'' (PASS) bajo el estándar TIA-568.2-D Categoría 6A.
...
\begin{enumerate}
    \item \textbf{Muestra:} Se seleccionará al azar una muestra representativa (ej. 10\% de los puntos, aprox. 30 nodos) distribuidos entre los niveles críticos (especialmente Nivel 3 - Laboratorios).
...
\begin{itemize}
    \item \textbf{Dossier de Certificación:} Archivo digital nativo y PDF con los 310 reportes individuales ``PASA''.
