...
\begin{enumerate}
    ...
    \item \textbf{Autorización de Intervención Física:} Permiso emitido por la Unidad de Mantenimiento/Infraestructura para realizar perforaciones, fijación de canaletas y uso de los ductos montantes existentes en los cuatro niveles del edificio.
    \begin{enumerate}
...
Se formaliza la autorización para la habilitación exclusiva de los espacios identificados en los planos de diseño como MDF (Main Distribution Frame) e IDF (Intermediate Distribution Frame) en los cuatro niveles del edificio.

\begin{itemize}
    \item \textbf{Derecho de Uso:} El contratista está facultado para instalar gabinetes, anclajes antisísmicos y organizadores verticales en las áreas designadas.
...
Dado que los trabajos se realizarán en ambientes de enseñanza (Aulas 101-108, Laboratorios 301-312), el permiso de uso está condicionado al cronograma académico:
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Planos finales en AutoCAD con la ubicación exacta de los 310 puntos y la ruta de canalización real.
