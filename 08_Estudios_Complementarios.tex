...
\begin{enumerate}
    ...
    \begin{itemize}
        \item \textbf{IDF-04 (Nivel 4):} Se proyecta una carga de consumo de 1.5 kVA, requiriendo una toma eléctrica dedicada tipo NEMA 5-15R o L5-20R con tierra aislada.
        \item \textbf{MDF/IDF-03 Densos (Niveles 2, 3):} Debido a la alta densidad de switches PoE del MDF y, especialmente, de los laboratorios del tercer piso, se estima una carga de 3 kVA para el MDF y de al menos \textbf{5 kVA para el IDF-03}. La infraestructura eléctrica debe contar con circuitos independientes de 20A o 30A para evitar disparos de llaves térmicas al encender los equipos.
    \end{itemize}
