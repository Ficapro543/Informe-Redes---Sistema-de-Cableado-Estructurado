...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Compatibilidad Cat 6A:} El cable U/UTP Cat 6A posee un diámetro exterior nominal de 7.2 mm a 8.0 mm. Los ductos existentes de 1/2'' son insuficientes para alojar dos cables de datos (necesarios para puntos dobles) respetando el factor de llenado del 40\%.
...
\subsection*{Evaluación del Riesgo para Categoría 6A (Alien Crosstalk)}

Además del ruido externo, el principal desafío técnico para el cableado Categoría 6A U/UTP es el Alien Crosstalk (AXT) o Diafonía Exógena.
...
\begin{itemize}
    ...
    \item \textbf{Riesgo Detectado:} En los tramos principales (salida del gabinete hacia los laboratorios del Nivel 3), se formarán mazos densos de cables. Si estos se agrupan apretadamente sin precaución, el ruido inducido degradará la señal, impidiendo la certificación a 10 Gbps.
\end{itemize}
...
El entorno electromagnético del Pabellón de Ingeniería Informática se clasifica como MICE 1 (Entorno de Oficina/Comercial). Bajo esta clasificación, y aplicando rigurosamente las distancias de separación y técnicas de instalación descritas, el cableado U/UTP Categoría 6A propuesto operará con márgenes de seguridad óptimos, sin requerir apantallamiento adicional.
...
\begin{enumerate}
    ...
    \item \textbf{Anclaje Antisísmico:} La infraestructura existente permite la fijación de los gabinetes al piso mediante pernos de expansión (tipo Hilti o similar) de 3/8'' o 1/2''. En el caso de racks adosados a pared (si los hubiera en Nivel 4), se requerirá verificar que el muro sea de concreto o ladrillo macizo (no Drywall) para soportar el torque de carga.
\end{enumerate}
