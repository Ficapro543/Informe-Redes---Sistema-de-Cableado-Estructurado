...
\begin{itemize}
    \item \textbf{Patch Panels:} Módulos modulares descargados de 24 puertos Cat 6A angulares, marca \textbf{CommScope} modelo \texttt{760237040}, para optimizar el espacio y evitar el estrés mecánico en los patch cords. Se instalarán un total de 30 paneles distribuidos para atender de forma ordenada la densidad de puntos: 1 panel en el IDF del 1er piso (IDF-01), 4 en el MDF (2do piso - MDF-02), 19 en el IDF del 3er piso (IDF-03) y 6 en el IDF del 4to piso (IDF-04) (dando un total de 720 puertos disponibles para los \totalPuntos{} puntos activos y la respectiva holgura).
...
\begin{itemize}
    \item \textbf{Switches de Acceso:} Switches gestionables de Capa 2/3 con soporte \textbf{PoE+ (Power over Ethernet - IEEE 802.3at)} marca \textbf{Cisco} serie \textbf{Catalyst 9200}, modelos \texttt{C9200-48P-E} (\totalSwitchesCuarentaYOcho{} unidades) y \texttt{C9200-24P-E} (\totalSwitchesVeinticuatro{} unidad), con puertos de bajada a 1 Gbps Base-T y uplinks de 10 Gbps SFP+ para el backbone de fibra óptica. Se distribuirán: 1x C9200-24P-E en el IDF del 1er piso (IDF-01), 2x C9200-48P-E en el MDF (2do piso), 10x C9200-48P-E en el IDF del 3er piso (IDF-03) y 3x C9200-48P-E en el IDF del 4to piso (IDF-04).
    \item \textbf{Transceptores SFP+:} Módulos SFP+ multimodo 10 GBase-SR, marca \textbf{Cisco} modelo \texttt{SFP-10G-SR}, para los enlaces de fibra entre el MDF del segundo piso y los IDF del primer, tercer y cuarto piso (6 unidades en total: 2 transceptores por cada uno de los 3 enlaces de backbone).
    \item \textbf{Puntos de Acceso Inalámbrico (WiFi 6):} Access Points de interior doble banda (2.4 GHz / 5 GHz) con soporte \textbf{WiFi 6 (802.11ax)}, marca \textbf{Cisco} modelo \texttt{C9120AXI}, alimentados mediante PoE+. Se instalarán estratégicamente en pasadizos y ambientes comunes de los niveles indicados (\totalAP{} unidades en total: 4 APs en el 1.er piso y 3 APs en el 2.do piso), de modo que se elimina su despliegue en los pisos 3 y 4 según los requerimientos del rediseño.
    \item \textbf{Cámaras IP (CCTV):} Cámaras IP fijas de interior con resolución mínima de 2 MP (1920x1080), PoE+, marca \textbf{Dahua} o \textbf{Hikvision}, conectadas a los switches de acceso PoE+. Se proyecta un total de \totalCamaras{} cámaras (\textbf{4 en el 2.do piso} y \textbf{8 en el 4.to piso}) integradas con el NVR (Network Video Recorder) de 16 canales que se ubicará en el gabinete MDF del segundo piso para la grabación y gestión centralizada de video.
