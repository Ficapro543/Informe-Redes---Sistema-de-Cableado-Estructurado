...
\begin{itemize}
    \item \textbf{Primer nivel (Aulas y áreas administrativas):} no cuenta con gabinete IDF; sus cables ascienden directamente al MDF del segundo piso por tubería conduit. Se proyectan \textbf{20 puntos de red} en total: 8 faceplates dobles (16 puertos RJ45), 4 puntos para AP y 0 cámaras.
    \item \textbf{Segundo nivel (Nivel principal de red):} alberga el MDF, que concentra el cableado del primer y segundo piso. Se proyectan \textbf{85 puntos de red} en total: 39 faceplates dobles (78 puertos RJ45), 3 puntos para AP, 4 cámaras y 2 gabinetes ZG.
    \item \textbf{Tercer nivel (Alta densidad académica):} concentra los 10 laboratorios de cómputo y el Centro de Capacitación en Informática (CCI). Cuenta con el IDF-03, conectado al MDF mediante backbone de fibra óptica OM4, y 10 gabinetes ZG, uno por laboratorio. Se proyectan \textbf{448 puntos de red}: 224 faceplates dobles (448 puertos RJ45), 0 AP y 0 cámaras.
    \item \textbf{Cuarto nivel (Gestión e investigación):} comprende los cubículos de docentes, el auditorio, el laboratorio de investigación y el control de cámaras. Cuenta con el IDF-04, conectado al MDF mediante backbone de fibra óptica OM4, y 2 gabinetes ZG. Se proyectan \textbf{128 puntos de red}: 60 faceplates dobles (120 puertos RJ45), 0 AP y 8 cámaras.
\end{itemize}
...
\begin{itemize}
    ...
    \item Suministro e instalación de cableado backbone de \textbf{fibra óptica multimodo OM4} entre el MDF (segundo piso) y los IDF-03 e IDF-04 (tercer y cuarto piso), además del backbone de cobre Cat 6A del primer piso al MDF.
    \item Instalación de \textbf{tres gabinetes principales} de telecomunicaciones: MDF de 42U en el segundo piso, IDF-03 de 24U en el tercer piso e IDF-04 de 24U en el cuarto piso, incluyendo patch panels, organizadores y sistema de puesta a tierra.
