...
El presente proyecto corresponde a la implementación de un sistema de cableado estructurado, red de datos y conectividad inalámbrica para toda la Facultad de Ingeniería Eléctrica, Electrónica, Informática y Mecánica de la Universidad Nacional de San Antonio Abad del Cusco, ubicada en la Ciudad Universitaria de Perayoc. La memoria se desarrolla tomando como base los planos disponibles de la Escuela Profesional de Ingeniería Informática y de Sistemas, los cuales presentan la estructura del pabellón y sirven como soporte para el trazado de canalizaciones, rutas y puntos de red.
...
El alcance del proyecto comprende la implementación completa de la infraestructura de cableado y red en la Facultad de Ingeniería Eléctrica, Electrónica, Informática y Mecánica, considerando la instalación física y la configuración básica para operación.
